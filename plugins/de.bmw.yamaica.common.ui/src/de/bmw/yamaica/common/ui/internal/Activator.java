...
package de.bmw.yamaica.common.ui.internal;
...
public class Activator extends AbstractUIPlugin
{
    ...
    // The plug-in ID
    public static final String         PLUGIN_ID     = "de.bmw.yamaica.common.ui";                         //$NON-NLS-1$
    ...
    public void start(BundleContext bundleContext) throws Exception
    {
        ...
        {
            de.bmw.yamaica.common.ui.internal.Activator.getDefault();
        }
