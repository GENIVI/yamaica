...
public interface YamaicaUIConstants extends YamaicaConstants
{
    ...
    String PACKAGE_ICON_PATH                        = "icons/full/obj16/package_obj.gif";
    String SHOW_QUALIFIED_ICON_PATH                 = "icons/full/elcl16/th_showqualified.gif";
    ...
    String TRANSFORM_ICON_PATH                      = "icons/full/elcl16/javaassist_co.gif";
}
