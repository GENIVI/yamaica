...
public class Preferences extends PreferencePage implements IWorkbenchPreferencePage
{
    ...
    protected Control createContents(Composite parent)
    {
        ...
        createEditorLinkFieldEditor = new BooleanFieldEditor(CREATE_YAMAICA_EDITOR_LINK, CREATE_YAMAICA_EDITOR_LINK_BUTTON_TEXT,
                projectSettings);
        createEditorLinkFieldEditor.setPreferenceStore(getPreferenceStore());
        ...
        // The de.bmw.yamaica.ide.ui.workbenchobserver bundle is an optional dependency. Thus
        ...
        if (null != Platform.getBundle(YamaicaUIConstants.WORKBENCHOBSERVER_PLUGIN_ID))
        {
            ...
            String[][] menuBarHidingRuleNamesAndValues = new String[][] {
                    { YamaicaUIConstants.YAMAICA_DEFAULT, de.bmw.yamaica.ide.ui.workbenchobserver.Preferences.YAMAICA_HIDE },
                    { ALWAYS_HIDE, de.bmw.yamaica.ide.ui.workbenchobserver.Preferences.ALWAYS_HIDE },
                    { NEVER_HIDE, de.bmw.yamaica.ide.ui.workbenchobserver.Preferences.NEVER_HIDE } };

            menuBarHidingRuleFieldEditor = new ComboFieldEditor(de.bmw.yamaica.ide.ui.workbenchobserver.Preferences.MENU_BAR_HIDING_RULE,
                    MENU_BAR_HIDING_RULE, menuBarHidingRuleNamesAndValues, guiSettings);
            menuBarHidingRuleFieldEditor.setPreferenceStore(de.bmw.yamaica.ide.ui.workbenchobserver.Preferences.getPreferenceStore());
