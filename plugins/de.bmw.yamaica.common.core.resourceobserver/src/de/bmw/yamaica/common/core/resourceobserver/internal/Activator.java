...
package de.bmw.yamaica.common.core.resourceobserver.internal;
...
{
    // The plug-in ID
    public static final String     PLUGIN_ID = "de.bmw.yamaica.common.core.resourceobserver"; //$NON-NLS-1$
